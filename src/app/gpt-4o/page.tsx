...
import App from './wrapped24';
import React from 'react';

export default function Home() {

    const [seeMarkdownVersion, setSeeMarkdownVersion] = React.useState(false);
...
`
    return (
        <div className="">
            {seeMarkdownVersion ? (
                <button onClick={() => setSeeMarkdownVersion(false)}>See Website</button>
            ) : (
                <button onClick={() => setSeeMarkdownVersion(true)}>See Markdown Version</button>
            )}
